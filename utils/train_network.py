...
def train_balanced_network(network, optimizer, scheduler, parameters, train_dataloader, val_dataloader, compute_device, network_directory, results_directory):
    ...
    for epoch in range(parameters.epoch, parameters.num_epochs):
        ...
        torch.save(functions.convert_data_parallel(network), os.path.abspath(f'{network_directory}{parameters.experiment}_weights.pth'))
...
def train_imbalanced_network(network, optimizer, scheduler, parameters, train_dataloader, val_dataloader, compute_device, network_directory, results_directory):
    # Create classification loss function
    classification_loss_func = nn.CrossEntropyLoss()
