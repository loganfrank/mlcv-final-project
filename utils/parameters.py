...
class Parameters():
    ...
    def __init__(self, experiment='baseline', epoch=0, num_epochs=1000, batch_size=1, learning_rate=1.0e-3, weight_decay=1.0e-5, momentum=0.9, best_network_epoch=0, patience=10, best_val_error=math.inf, early_stopping=False, parallel=False):
